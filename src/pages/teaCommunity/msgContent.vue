<template>
  <div class="container">
    ...
    <div class="comment-list lm-margin-t-sm" v-infinite-scroll="loadMore"
      ...
      <div class="comment" v-for="(info,index) in infoList" :key="index">
        <div class="user flex-alig-center">
          ...
          <div class="toreply flex-alig-center">
            ...
            <span v-show="typeId!=2"><img src="../../assets/images/teaCommunity/reply.png" @click="jump(info.ThemeId,info.BackId,info.Nickname)"/></span>
          </div>
        </div>
        <div class="content-p lm-font-sm">
          <span v-show="typeId!=2">回复了<span class="lm-text-red">你</span>：</span>{{info.Content}}
        </div>
      </div>  
       <!--加载中。。。-->
